...
class UMyWheeledVehicleMovementComponent4W;
...
private:
	...
	{
		FSteeringCurveEditor(UMyWheeledVehicleMovementComponent4W * InVehicle = NULL);
	...
	private:
		UMyWheeledVehicleMovementComponent4W * VehicleComponent;
		UObject* Owner;
	...
	{
		FTorqueCurveEditor(UMyWheeledVehicleMovementComponent4W * InVehicle = NULL);
		/** FCurveOwnerInterface interface */
		virtual TArray<FRichCurveEditInfoConst> GetCurves() const override;
		virtual TArray<FRichCurveEditInfo> GetCurves() override;
		virtual void ModifyOwner() override;
