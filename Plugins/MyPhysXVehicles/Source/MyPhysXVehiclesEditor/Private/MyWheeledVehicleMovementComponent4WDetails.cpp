...
void FWheeledVehicleMovementComponent4WDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	else if (UMyWheeledVehicleMovementComponent4W * VehicleComponent = Cast<UMyWheeledVehicleMovementComponent4W>(SelectedObjects[0].Get()))
	{
...
FWheeledVehicleMovementComponent4WDetails::FSteeringCurveEditor::FSteeringCurveEditor(UMyWheeledVehicleMovementComponent4W * InVehicle)
{
...
FWheeledVehicleMovementComponent4WDetails::FTorqueCurveEditor::FTorqueCurveEditor(UMyWheeledVehicleMovementComponent4W * InVehicle)
{
	VehicleComponent = InVehicle;
	Owner = VehicleComponent;
}
