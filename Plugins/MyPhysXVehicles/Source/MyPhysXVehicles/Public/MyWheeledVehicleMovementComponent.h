...
#include "MyWheeledVehicleMovementComponent.generated.h"
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	...
	TSubclassOf<UMyVehicleWheel> WheelClass;
...
USTRUCT()
struct  FMyReplicatedVehicleState
{
	GENERATED_BODY()

	FMyReplicatedVehicleState();
...
struct  FMyVehicleInputRate
{
	...
	FMyVehicleInputRate() : RiseRate(5.0f), FallRate(5.0f) { }
...
public:
	...
	/** Wheels to create */
	UPROPERTY(EditAnywhere, Category=VehicleSetup)
	TArray<FMyWheelSetup> WheelSetups;
	...
	TArray<class UMyVehicleWheel*> Wheels;
	...
	virtual void GenerateTireForces(class UMyVehicleWheel* Wheel, const FMyTireShaderInput& Input, FMyTireShaderOutput& Output);
...
protected:
	...
	FMyReplicatedVehicleState ReplicatedState;
	...
	FMyVehicleInputRate ThrottleInputRate;

	// Rate at which input brake can rise and fall
	UPROPERTY(EditAnywhere, Category=VehicleInput, AdvancedDisplay)
	FMyVehicleInputRate BrakeInputRate;

	// Rate at which input handbrake can rise and fall
	UPROPERTY(EditAnywhere, Category=VehicleInput, AdvancedDisplay)
	FMyVehicleInputRate HandbrakeInputRate;

	// Rate at which input steering can rise and fall
	UPROPERTY(EditAnywhere, Category=VehicleInput, AdvancedDisplay)
	FMyVehicleInputRate SteeringInputRate;
	...
	*/
	...
	virtual FVector GetWheelRestingPosition(const FMyWheelSetup& WheelSetup);
